...
const testData = [
  {
    ...
    description:
      "Our comprehensive impact testing evaluates glass container durability against external forces, ensuring products remain protected through manufacturing, shipping, and handling processes.",
    standard: "ASTM C1256",
  ...
  },
  {
    ...
    description:
      "We validate glass resilience against sudden temperature changes using advanced thermal shock methodology, crucial for products that undergo significant temperature variations.",
    standard: "ISO 7459",
  ...
  },
  {
    ...
    description:
      "Our pressure testing verifies structural integrity of containers designed for pressurized contents, ensuring long-term reliability and consumer safety across all conditions.",
    standard: "ASTM C147",
  ...
  return (
    <div>
      ...
      <div className="flex justify-center mb-8">
        <div
          className="flex items-center gap-3 p-1.5 bg-white/30 backdrop-blur-sm 
        ...
        >
          {testData.map((_, idx) => (
            <button
              key={idx}
              onClick={() =>
                document.getElementById(`test-${idx}`)?.scrollIntoView({
                  behavior: "smooth",
                  block: "center",
                })
              }
            ...
            >
              <span
                className="absolute inset-0 rounded-full bg-[#336B44]/10
          ...
          <React.Fragment key={test.id}>
            ...
            {index < testData.length - 1 && (
              <div className="relative w-full py-2">
                <div
                  className="absolute left-0 right-0 h-[2px] bg-gradient-to-r 
...
const TestFeature = memo(
  ({ test, index, isActive, setActive }: TestFeatureProps) => {
      ...
      >
        ...
        >
          <div className="relative group overflow-hidden">
            ...
            <div
              className="relative w-full h-[700px] rounded-2xl shadow-xl
                        overflow-hidden border-2 border-white
                        transform transition duration-700 object-cover object-center"
            >
        ...
        <motion.div
          className={`w-full md:w-[55%] ${
            isEven ? "md:pl-4 lg:pl-6" : "md:pr-4 lg:pr-6"
          }`}
        ...
        >
          ...
          <div
            className="bg-gradient-to-br from-white/80 to-[#EDE5DB]/70 
          ...
          >
            ...
            <p
              className="text-[#2A5A36]/80 text-sm sm:text-base leading-relaxed mb-5 max-w-xl relative z-10
            ...
            <div
              className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-4 mt-4 relative z-10
            ...
            >
              {[
                ...
                >
                  <div
                    className="flex-shrink-0 w-5 h-5 rounded-full bg-[#336B44]/10 
                             flex items-center justify-center mt-0.5
                             group-hover/item:bg-[#336B44]/20 transition-colors duration-300"
                  >
                    <div
                      className="w-2 h-2 rounded-full bg-[#336B44]
            ...
            >
              <button
                className="px-5 py-2.5 bg-[#336B44] text-white text-sm font-medium
              ...
              >
                ...
                <div
                  className="absolute inset-0 w-full h-full bg-[#244C31] 
